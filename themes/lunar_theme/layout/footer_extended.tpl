        ...
        <div class="poi-img"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icons/than-tai.png" /></div>
            <div class="wraper">
                <div class="container">
                    <!-- BEGIN: theme_type -->
             ...
             <div class="ps-img"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icons/hoa-dao.png" /></div>
        </nav>
        {ADMINTOOLBAR}
    </div>
    <!-- SiteModal Required!!! -->
