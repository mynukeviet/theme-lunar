<!-- BEGIN: main -->
<div id="hot-news">
	<div class="panel panel-default news_column color-img">
        <div class="panel-body">
            <div class="row">
                <div class="col-md-14 margin-bottom-lg">
                    ...
                    <p class="text-home">{main.hometext}</p>                    
                    <p class="text-right col-text"><a href="{main.link}"><em class="fa fa-sign-out"></em>{lang.more}</a></p>
                </div>
                <div class="col-md-10 margin-bottom-lg">
                    <ul class="column-margin-left">
                        <!-- BEGIN: othernews -->
                        <li class="icon_list clearfix icon-center">
